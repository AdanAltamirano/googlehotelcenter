...
namespace APIServices.Models
{
    ...
    public partial class OzHotelesEntities : DbContext
    {
        ...
        public virtual DbSet<GoogleSyncHistory> GoogleSyncHistory { get; set; }
        ...
        public virtual ObjectResult<spReservationLog_Result2> spReservationLog(string reservationId)
        {
            var reservationIdParameter = reservationId != null ?
                new ObjectParameter("ReservationId", reservationId) :
                new ObjectParameter("ReservationId", typeof(string));
