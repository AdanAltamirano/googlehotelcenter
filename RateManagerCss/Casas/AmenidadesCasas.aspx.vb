...
Public Class AmenidadesCasas
    Inherits System.Web.UI.Page

    Protected ctrlIdiomaCategoria As CtrlIdioma
    Protected ctrlIdiomaAmen As CtrlIdioma
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ctrlIdiomaCategoria.Width = 300

        ctrlIdiomaAmen.IsMultiline = False
        ctrlIdiomaAmen.MaxLength = 52
        ctrlIdiomaAmen.Width = 340

        ctrlIdiomaAmen.RequiredText = False
        ctrlIdiomaCategoria.RequiredText = False
        'ctrlIdiomaAmen.CargaDatos(201278)

        Gobal.ctrl_idioma_cat = ctrlIdiomaCategoria
        Gobal.ctrl_idioma_amen = ctrlIdiomaAmen
    ...
    Protected Sub agregar_cat_Click(sender As Object, e As EventArgs) Handles agregar_cat.Click
        ...
        Else
            ...
            Dim spSendCategory As String = "spAddCategory"
            ...
            Using Conn As New SqlConnection(connString)
                ...
                Try
                    ...
                    command.Parameters.Add("@idDicionario", SqlDbType.Int).Value = id_dic
    ...
    Protected Sub agregar_amen_Click(sender As Object, e As EventArgs) Handles agregar_amen.Click

        id_cat = Hidden1.Value
        amen_name_en = ctrlIdiomaAmen.GetEN
        amen_name_es = ctrlIdiomaAmen.GetES

        If amen_name_en = "" Or amen_name_es = "" Then
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "Script", "errorEmptyValues();", True)
        Else
            Dim id_dic As Integer = ctrlIdiomaAmen.Insert()

            Dim connString As String = ConfigurationManager.AppSettings("PortalConnectionString")
            Dim spAddAmenities As String = "spAddAmenitiesCubaHouses"
            Dim _error As String

            Using Conn As New SqlConnection(connString)
                Conn.Open()
                Dim command As New SqlCommand(spAddAmenities, Conn)

                Try
                    command.CommandType = CommandType.StoredProcedure
                    command.Parameters.Add("@idRubro", SqlDbType.Int).Value = 10
                    ...
                    command.Parameters.Add("@aparecebusqueda", SqlDbType.Bit).Value = 0
                    command.Parameters.Add("@codigo", SqlDbType.Int).Value = 0
