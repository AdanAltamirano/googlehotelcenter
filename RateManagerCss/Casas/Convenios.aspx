<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Convenios.aspx.vb" Inherits="RateManager.ConveniosCasas" %>
...
<%@ Register TagPrefix="uc3" TagName="ctrlIdioma" Src="~/Modulos/CtrlIdioma.ascx" %>
                        ...
                        <table align="center" border="0" style="width:954px;">
                         ...
                         <table id="tabEditConvenio" runat="server" align="center" border="0" visible="false">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                <asp:Label ID="lblRPDesc" runat="server"> descripcion rateplan </asp:Label>
                                <br />
                                    <uc3:CtrlIdioma runat="server" ID="descripcionRatePlan" />
                                </td>
                            </tr>
