...
Partial Public Class Convenios
        ...
        If ValidaCampos() Then
            ...
            If RatesPlan IsNot Nothing AndAlso RatesPlan.Length > 0 AndAlso RatesPlan(0).Length > 0 Then
                ...
                If Me.chkIsGeneral.Checked Then
                    flag = adapter.SaveAgreement(isEditMode, idAgreement, "", "", "", "", "", 0, "", "", "", txtNoAgreement.Text.Trim, txtCorporateContact.Text.Trim, txtCorporateJob.Text.Trim, False, True, RatesPlan, generalRestrictions, especificRestrictions, usedEspecificRestrictions, saveResponse, idOffice, idContact, chkCC.Checked, sD, UsuarioHotelId, digitoVer:=digito)
                Else
                    flag = adapter.SaveAgreement(isEditMode, idAgreement, txtAgency.Text.Trim, txtAddress.Text.Trim, txtTown.Text.Trim, txtZIP.Text.Trim, txtPhone.Text.Trim, Me.selectedCity.Value, txtContact.Text.Trim, txtJob.Text.Trim, txtEmail.Text.Trim, txtNoAgreement.Text.Trim, txtCorporateContact.Text.Trim, txtCorporateJob.Text.Trim, cmbSegmento.SelectedValue, False, RatesPlan, generalRestrictions, especificRestrictions, usedEspecificRestrictions, saveResponse, idOffice, idContact, chkCC.Checked, sD, UsuarioHotelId, digitoVer:=digito)
                End If
    ...
    Private Sub LoadHotelesConveio(ByVal rateplan As String)
        Dim ds As DataSet = (New RatePlanAccess).GetHotelByTarifaConvenio(rateplan, idConvenio, idCorporate)
