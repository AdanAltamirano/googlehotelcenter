<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FaresCataloguePromoNR.aspx.vb"
    Inherits="RateManager.FaresCataloguePromoNR" EnableEventValidation="true" %>

<%@ Import Namespace="RateManager" %>
<%@ Register TagPrefix="uc2" TagName="ctrRateAplicationNRpromo" Src="../Modulos/ctrRateAplicationNRpromo.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ctrlPlanFares" Src="../Modulos/ctrlPlanFaresPromoNR.ascx" %>
<%@ Register TagPrefix="uc1" TagName="CtrlPlanFaresExc" Src="../Modulos/CtrlPlanFaresExcPromoNR.ascx" %>
<%@ Register Src="../Modulos/ctlMensajes.ascx" TagName="ctlMensajes" TagPrefix="uc3" %>
...
<!--
        ...
        function CheckValContract(min, max, nr, uv, msgMax, msgMin) {
            ...
            if (document.getElementById(uv)) {
                ...
                document.getElementById(uv).value = Math.round(NR);
            }
                                    ...
                                    <tr>
                                        <td>
                                            <table cellspacing="1" cellpadding="1" width="100%" border="0">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <uc2:ctrRateAplicationNRpromo ID="ctrRateAplicationNRpromo1" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td align="center">
                                                        <%
                                                            If Not Me.IsSupervisor Then
                                                                Me.btnSave.OnClientClick = "return (" + Me.ctrRateAplicationNRpromo1.ID + "_ValidateRates());"
                                                            End If
                                                        %>
                                                        <%  If Me.IsSupervisor Then
