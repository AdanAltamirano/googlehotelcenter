...
Partial Class FaresCatalogueNR
    ...
    Public ReadOnly Property IdTextBoxPorcMax() As String
        Get
            Return Me.CtrRateAplication1.m_TextBoxPorcMax
        End Get
    End Property

    Public ReadOnly Property IdTextBoxPorcMin() As String
        Get
            Return Me.CtrRateAplication1.m_TextBoxPorcMin
        End Get
    End Property
...
#Region " C�digo generado por el Dise�ador de Web Forms "
    ...
    Protected WithEvents CtrlPlanFaresExc2 As CtrlPlanFaresExcNR
    Protected WithEvents CtrlPlanFares2 As ctrlPlanFaresNR
    Protected WithEvents CtrRateAplication1 As ctrRateAplicationNR
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CtrRateAplication1.setPorcMinMax()
        ...
        If Not IsPostBack Then
            ...
            Me.CtrRateAplication1.MinPercentControlId = Me.CtrlPlanFaresExc2.MinStorageControlId
            Me.CtrRateAplication1.MaxPercentControlId = Me.CtrlPlanFares2.MaxStorageControlId
            Me.CtrRateAplication1.MaxPercentControlId = Me.CtrlPlanFaresExc2.MaxStorageControlId
            ...
            CtrlPlanFares2.PlusTaxProperty = CtrRateAplication1.PlusTaxProperty
            CtrlPlanFares2.EcotasaProperty = CtrRateAplication1.EcotasaProperty
            CtrlPlanFaresExc2.PlusTaxProperty = CtrRateAplication1.PlusTaxProperty
            CtrlPlanFaresExc2.EcotasaProperty = CtrRateAplication1.EcotasaProperty
                ...
                If checkBoxTemp.Checked Then
                    ...
                    With New FaresSystem
                        If .DeleteFares(iFareIdTemp) Then
                            Me.guardalog("/Pages/FaresCatalogueNR.aspx", PaginaBase.acciones.Eliminar, "Se elimin� la tarifa de la habitaci�n " & room.Cells(dgcolumns.codigohabitacion).Text & " de la fecha " & room.Cells(dgcolumns.FechaInicia).Text & " a la fecha " & room.Cells(dgcolumns.FechaFinaliza).Text & " con el rateplan " & labelTemp.Text)
    ...
    Private Sub loadCulture()
        lblTitle.Text = PortalCulture.GetString("01134")

        If Editando Then
            lblMsg.Text = String.Format("{0} {1}", PortalCulture.GetString("01250"), PortalCulture.GetString("01019"))
        Else
            lblMsg.Text = String.Format("{0} {1}", PortalCulture.GetString("00102"), PortalCulture.GetString("01134"))
        End If
    ...
    Protected ReadOnly Property RateModeView() As Integer
        Get
            ...
            If IsSupervisor Then
                ...
                If (Not Me.CtrlPlanFares2.IsFareValuesEqualTo("Adult", Me.CtrRateAplication1.GetFareFor("Adult", False), False) _
                    ...
                    Not Me.CtrlPlanFares2.IsFareValuesEqualTo("Teen", Me.CtrRateAplication1.GetFareFor("Teen", False), False) _
                     OrElse (Me.CtrlPlanFaresExc2.FieldException <> "NNNNNNN" _
            ...
            End If
            If (Not Me.CtrlPlanFares2.IsFareValuesEqualTo("Adult", Me.CtrRateAplication1.GetFareFor("Adult", True), True) _
                    OrElse
                    Not Me.CtrlPlanFares2.IsFareValuesEqualTo("Children", Me.CtrRateAplication1.GetFareFor("Child", True), True) _
                    OrElse
                    Not Me.CtrlPlanFares2.IsFareValuesEqualTo("Teen", Me.CtrRateAplication1.GetFareFor("Teen", True), True) _
                OrElse
             (Me.CtrlPlanFaresExc2.FieldException <> "NNNNNNN" _
               AndAlso (Not Me.CtrlPlanFaresExc2.IsFareValuesEqualTo("Adult", Me.CtrRateAplication1.GetFareFor("Adult", True), True) _
               OrElse
               Not Me.CtrlPlanFaresExc2.IsFareValuesEqualTo("Children", Me.CtrRateAplication1.GetFareFor("Child", True), True) _
               OrElse
               Not Me.CtrlPlanFaresExc2.IsFareValuesEqualTo("Teen", Me.CtrRateAplication1.GetFareFor("Teen", True), True)
           ))) Then
                value = 1
            End If
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click, btnPublish.Click
        ...
        Dim isValidFaresExc2 As Boolean = CtrlPlanFaresExc2.IsValidData
        Dim isValidFares As Boolean = CtrlPlanFares2.IsValidData
        Dim isValidNRpromo As Boolean = Me.CtrRateAplication1.IsValidData
        ...
        If isValidFaresExc2 AndAlso isValidFares AndAlso isValidNRpromo Then
            ...
            If Me.idroom <> 0 Then
                ...
                If Page.IsValid Then
                    ...
                    Dim isNew As Boolean = (Me.CtrRateAplication1.m_iFareId = 0)
                    '  actualizaidroom()
                    ...
                    For i As Integer = 1 To CtrRateAplication1.lstDatesCount
                        ...
                        'cuando es modificaci�n la primera se modifica pero las demas son add
                        chLast = String.Empty
                        rpLast = String.Empty
                        f1Last = String.Empty
                        f2Last = String.Empty
                        ...
                        If CtrRateAplication1.AddFare(idroom, CtrRateAplication1.m_iFareId, f1, f2, chLast, rpLast, f1Last, f2Last, ddlRooms.SelectedItem.Text, publish, (bPorOcupacion = 1), lstFare, scorreo) = True Then
                            ...
                            '        errorElementProperty.Add(New System.Xml.Linq.XAttribute("Type", "3"), New System.Xml.Linq.XAttribute("Code", "448"), New System.Xml.Linq.XText(ex.Message))
                            '        errorsElement.Add(errorElementProperty)
                            '        Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Sincronizar, "Error al sincronizar con APICache", "", "", errorsElement.ToString(), info.Hotel)
                            '    End Try
                    ...
                    If _exito = True Then
                        ...
                        If Not CType(Me.Page, PaginaBase).IsSupervisor Then
                            Try
                                ...
                                If ConfigurationManager.AppSettings("RatesChangesNotificationMail") IsNot Nothing Then Mail.To = ConfigurationManager.AppSettings("RatesChangesNotificationMail")
                                ...
                                Mail.AddParameter("RATECODE") = Me.CtrRateAplication1.RatePlanRow.RATECODE
            ...
            End If
        Else
            If Not isValidFaresExc2 OrElse (Not isValidNRpromo AndAlso Me.CtrRateAplication1.SelectedddlShowRates = 1) Then

                Page.ClientScript.RegisterStartupScript(Me.GetType(), "ShowPrice", "<script>optionSw('1E');</script>")
            End If
            If Not isValidFares OrElse (Not isValidNRpromo AndAlso CtrRateAplication1.SelectedddlShowRates = 1) Then
    ...
    Private Sub SendClosureToService(ByVal rateId As Integer, ByVal startDate As Date, ByVal endDate As Date, ByVal endpoint As String, ByVal service As String, ByVal info As companyInfo)
        ...
        For Each response As Models.Restrictions.Response.RestrictionResponse In restrictionResponseList
            ...
            If response.IsSuccess Then
                Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Sincronizar, note, "", response.Restrictions(0).XmlRequest(0).ToString(), response.Restrictions(0).Xml(0).ToString(), info.Hotel)
            Else
                Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Sincronizar, noteError, "", response.Xml.ToString(), "", info.Hotel)
            End If
    ...
    Private Sub SendRatesToService(ByVal ratesForRequest As RatesMessages, ByVal hotelId As Integer, ByVal endpoint As String, ByVal endpointDelete As String, ByVal service As String, Optional ByVal deleteRates As Boolean = True)
        ...
        Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Sincronizar, note, "", res.Item1.RequestXML, res.Item1.Xml, hotelId)

        'Delete Log
        If res.Item2 IsNot Nothing Then
            Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Eliminar, noteDelete, "", res.Item2.RequestXML, res.Item1.Xml, hotelId)
        End If
    ...
    Private Sub SendDeleteToService(ByVal rateAmountMessages As RateAmountMessages, ByVal hotelId As Integer, ByVal endpoint As String, ByVal service As String)
        ...
        Try
            ...
            Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Eliminar, note, "", res.RequestXML, res.Xml, hotelId)
        ...
        Catch ex As Exception
            ...
            Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Eliminar, noteError, "", "", errorsElement.ToString(), hotelId)
        End Try
    End Sub
...
#Region "Delete Google Async"
    Private Async Function SendDeleteAsync(ByVal userName As String, ByVal userId As Integer, ByVal hotelId As Integer, ByVal companyId As Integer,
        ...
        Catch ex As Exception
            ...
            HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, Actions.Eliminar, "Error en SendDeleteAsync", "", errorsElement.ToString(), "")
        End Try
    ...
    Private Async Function SendDeleteIfEnabledAsync(ByVal userName As String, ByVal userId As Integer, ByVal hotelId As Integer, ByVal rateAmountMessages As RateAmountMessages, ByVal isEnabled As Boolean, ByVal endpoint As String, ByVal service As String) As Task
        ...
        If isEnabled Then
            ...
            Catch ex As Exception
                ...
                HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, Actions.Eliminar, $"Error en SendDeleteIfEnabledAsync {service}", "", errorsElement.ToString(), "")
            End Try
        End If
    ...
    Private Async Function SendDeleteToServiceAsync(ByVal userName As String, ByVal userId As Integer, ByVal rateAmountMessages As RateAmountMessages, ByVal hotelId As Integer, ByVal endpoint As String, ByVal service As String) As Task
        ...
        Try
            ...
            HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, RateManager.Utitlities.Hotel.Actions.Eliminar, note, "", res.RequestXML, res.Xml)
        ...
        Catch ex As Exception
            ...
            HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, RateManager.Utitlities.Hotel.Actions.Eliminar, noteError, "", errorsElement.ToString(), "")
...
#Region "SendRates Google Async"
    ...
    Private Async Function SendRatesAsync(ByVal hotelId As Integer, ByVal companyId As Integer, ByVal rateId As Integer, ByVal startDate As Date, ByVal endDate As Date, ByVal userName As String, ByVal userId As Integer) As Task
        ...
        Catch ex As Exception
            ...
            HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, Actions.Sincronizar, "Error en SendRatesAsync", "", errorsElement.ToString(), "")
        End Try
    End Function
    ...
    Private Async Function SendRatesIfEnabledAsync(ByVal userName As String, ByVal userId As Integer, ByVal isEnabled As Boolean,
        ...
        If isEnabled AndAlso ratesForRequest IsNot Nothing Then
            ...
            Catch ex As Exception
                ...
                HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, Actions.Sincronizar, $"Error al sincronizar con {serviceName}", "", errorsElement.ToString(), "")
    ...
    Private Async Function SendRatesToServiceAsync(ByVal userName As String, ByVal userId As Integer, ByVal ratesForRequest As RatesMessages, ByVal hotelId As Integer, ByVal endpoint As String, ByVal endpointDelete As String, ByVal service As String, Optional ByVal deleteRates As Boolean = True) As Task
        ...
        HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, RateManager.Utitlities.Hotel.Actions.Sincronizar, note, "", res.Item1.RequestXML, res.Item1.Xml)

        If res.Item2 IsNot Nothing Then
            HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, RateManager.Utitlities.Hotel.Actions.Eliminar, noteDelete, "", res.Item2.RequestXML, res.Item2.Xml)
        End If
    ...
    Private Async Function SendClosureToServiceAsync(ByVal userName As String, ByVal userId As Integer, ByVal rateId As Integer, ByVal startDate As Date, ByVal endDate As Date,
        ...
        For Each response As Models.Restrictions.Response.RestrictionResponse In restrictionResponseList
            ...
            If response.IsSuccess Then
                HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, RateManager.Utitlities.Hotel.Actions.Sincronizar, note, "", response.Restrictions(0).XmlRequest(0).ToString(), response.Restrictions(0).Xml(0).ToString())

            Else
                HotelUtilitie.Log(userName, userId, "/Pages/FaresCatalogueNR.aspx", hotelId, Actions.Sincronizar, noteError, "", response.Xml.ToString(), "")
            End If
