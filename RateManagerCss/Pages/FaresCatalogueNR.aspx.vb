                        ...
                        If CtrRateAplication1.AddFare(idroom, CtrRateAplication1.m_iFareId, f1, f2, chLast, rpLast, f1Last, f2Last, ddlRooms.SelectedItem.Text, publish, (bPorOcupacion = 1), lstFare, scorreo) = True Then
                            ...
                            If isEnabledGoogleRequest Then
                                ...
                                Try
                                    ...
                                    Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Sincronizar, "Tarifa enviada a Conflux", "", res.Item1.RequestXML, res.Item1.Xml, info.Hotel)

                                    'Delete Log
                                    If res.Item2 IsNot Nothing Then
                                        Me.guardalog("/Pages/FaresCatalogueNR.aspx", acciones.Eliminar, "Eliminar tarifas Conflux", "", res.Item2.RequestXML, res.Item1.Xml, info.Hotel)
                                    End If
