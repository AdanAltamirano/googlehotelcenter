<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FaresCataloguePromo.aspx.vb"
    Inherits="RateManager.FaresCataloguePromo" EnableEventValidation="false" %>

<%@ Register Src="../Modulos/ctrRateAplicationExc.ascx" TagName="ctrRateAplicationExc"
    TagPrefix="uc1" %>
<%@ Register Src="../Modulos/ctrlExceptionFares.ascx" TagName="ctrlExceptionFares"
    TagPrefix="uc1" %>
<%@ Register Src="../Modulos/ctrlExceptionFaresExc.ascx" TagName="ctrlExceptionFaresExc"
    TagPrefix="uc1" %>
...
//-->
    ...
    <script>
        ...
        function ShowPrecios(ddlRate, divprec) {

            var ed = document.getElementById(ddlRate);
            var dp = document.getElementById('DivRates');
            var dn = document.getElementById(divprec);
                ...
                <table id="Table2" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table cellspacing="1" cellpadding="1" width="100%" border="0">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <uc1:ctrRateAplicationExc ID="ctrRateAplicationExc" runat="server" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                        <asp:HyperLink ID="hplShowRates" runat="server" CssClass="dglink">ShowRates</asp:HyperLink>
                                                        <asp:HyperLink ID="hplHideRates" runat="server" CssClass="dgPager">HideRates</asp:HyperLink>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                        ...
                        <BR>  Defina el precio de tarifa en ocupacion por adulto y el precio para niños, el campo total de tarifas mostrara el precio calculado por noche en habitación.</asp:Label>
                                                                            ...
                                                                            <tr>
                                                                                <td align="center">
                                                                                    ...
                                                                                    <div id="divA2" style="min-height: 100px; width: 100%" align="center" runat="server"
                                                                                        ...
                                                                                        <uc1:ctrlExceptionFares ID="CtrlPlanFares2" runat="server"></uc1:ctrlExceptionFares>
                                                                                    </div>
                                                                                    <div id="divB2" style="min-height: 100px; width: 100%; display: none" align="center"
                                                                                        runat="server" ms_positioning="FlowLayout">
                                                                                        <uc1:ctrlExceptionFaresExc ID="CtrlPlanFaresExc2" runat="server"></uc1:ctrlExceptionFaresExc>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                        ...
                                                        <asp:Label ID="lblPriceError" runat="server" CssClass="validators">Por Favor Agregue tarifa mayor que 0</asp:Label>
                                                        <asp:Label ID="lblError" runat="server" CssClass="validators" Visible="False">Agregue fecha de aplicación de la tarifa</asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left">
    ...
    <div class="clear">
        ...
        <asp:DataGrid ID="dgRooms" GridLines="None" runat="server" CssClass="datagrid" Width="99%"
            ...
            <Columns>
                ...
                <asp:BoundColumn HeaderText="Tarifa Minima" DataField="MinPrice" Visible="true">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundColumn>
                <asp:BoundColumn HeaderText="Tarifa Máxima" DataField="MaxPrice" Visible="true">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundColumn>
                ...
                <asp:BoundColumn DataField="idTarifaExcepcion" Visible="False"></asp:BoundColumn>
