...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FaresCatalogue.aspx.vb"
    Inherits="RateManager.FaresCatalogue"  %>
...
<body bottommargin="0" leftmargin="0" rightmargin="0" topmargin="0" ms_positioning="FlowLayout">
    ...
    <div class="clear">
        ...
        <div class="title">
            <asp:Label ID="lblTitle" runat="server" EnableViewState="False" Text="Tarifas" CssClass="tituloSeccion"></asp:Label>
        </div>
    </div>
    ...
    <div class="clear">
        ...
        <asp:DataGrid ID="dgRooms" GridLines="None" runat="server" CssClass="datagrid" Width="99%"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="MinPrice" HeaderText="Tarifa Minima">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundColumn>
                <asp:BoundColumn DataField="MaxPrice" HeaderText="Tarifa M&#225;xima">
                    <HeaderStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" />
                </asp:BoundColumn>
                ...
                <asp:BoundColumn Visible="False" DataField="NombrePlan" HeaderText="Plan"></asp:BoundColumn>
                <asp:TemplateColumn>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="False" CssClass="dgLink"
