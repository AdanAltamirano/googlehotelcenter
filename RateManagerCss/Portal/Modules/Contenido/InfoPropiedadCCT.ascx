...
<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InfoPropiedadCCT.ascx.vb" 
    Inherits="RateManager.InfoPropiedadCCT" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td valign="top" colspan="2">
                        ...
                        <asp:Label ID="lblInfoHotel" runat="server" CssClass="clslabel" Height="100%"></asp:Label>
                    </td>
                </tr>
                <%--<tr>
                    <td valign="top" colspan="2">
