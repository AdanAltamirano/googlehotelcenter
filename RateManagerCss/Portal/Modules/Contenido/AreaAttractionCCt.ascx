...
<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AreaAttractionCCt.ascx.vb" 
    Inherits="RateManager.AreaAttractionCCt" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
