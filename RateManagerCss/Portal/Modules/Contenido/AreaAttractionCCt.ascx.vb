...
Partial Public Class AreaAttractionCCt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ctrlLinkImagecct.Pagina = "Registro/AttractionInformationCCT.aspx"
        ctrlLinkImagecct.Nota = "Edición de la información de imagen de Atracciones Call Center"
        lnkInfo2.Pagina = "Registro/AttractionInformationCCT.aspx"
        lnkInfo2.Nota = "Edición de la información de Atracciones Call Center"
    ...
    Public Sub cargarTodo()
        ...
        CargaContenidoCCT(imgMapcct, 2, ctrlLinkImagecct, Opciones.TipoControl.Imagen, Me.idDelHotel, True, False, False, True, True)
        CargaContenidoCCT(lblInfoMapa, 2, lnkInfo2, Opciones.TipoControl.Label, Me.idDelHotel, False, False, True, False, False)
        ...
        Me.lblTitle.Text = PortalCulture.GetString("00404")
