...
Partial Public Class CtrlDistanciasCCT
    Inherits Opciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ctrlLinkImagecct.Pagina = "Registro/DistancesCCT.aspx"
        ctrlLinkImagecct.Nota = "Edición de la información de imagen de distancias Call Center"
        lnkInfo2.Pagina = "Registro/DistancesCCT.aspx"
        lnkInfo2.Nota = "Edición de la información de distancias Call Center"
    ...
    Public Sub cargarTodo()
        ...
        CargaContenidoCCT(imgMapcct, 3, ctrlLinkImagecct, Opciones.TipoControl.Imagen, Me.idDelHotel, True, False, False, True, True)
        CargaContenidoCCT(lblInfoMapa, 3, lnkInfo2, Opciones.TipoControl.Label, Me.idDelHotel, False, False, True, False, False)
        ...
        lblTitle.Text = PortalCulture.GetString("A00753")
