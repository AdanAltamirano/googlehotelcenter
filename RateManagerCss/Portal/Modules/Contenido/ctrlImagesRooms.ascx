<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlImagesRooms.ascx.vb" Inherits="RateManager.ctrlImagesRooms" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
