...
Partial Public Class MapLocationCCT
    Inherits Opciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ctrlLinkImagecct.Pagina = "Registro/MapLocationInformationCCT.aspx"
        ctrlLinkImagecct.Nota = "Edición de la información de imagen del Mapa Call Center"
        lnkInfo2.Pagina = "Registro/MapLocationInformationCCT.aspx"
        lnkInfo2.Nota = "Edición de la información del Mapa Call Center"
    ...
    Public Sub cargarTodo()
        ...
        CargaContenidoCCT(imgMapcct, 1, ctrlLinkImagecct, Opciones.TipoControl.Imagen, Me.idDelHotel, True, False, False, True, True)
        CargaContenidoCCT(lblInfoMapa, 1, lnkInfo2, Opciones.TipoControl.Label, Me.idDelHotel, False, False, True, False, False)
