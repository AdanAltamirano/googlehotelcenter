...
var gsOutOfRange="No se pude seleccionar una fecha fuera de este rango !";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"No se puede seleccionar ahora!\");return false;' onmouseover='return true;' >Hoy : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A>";	// the content of the bottom section.
...
var gcWorkday = "#52708a"; // Workday font color
var gcSat = "#52708a"; // Saturday font color
var gcSatBG = ""; // Saturday background color
var gcSun = "#52708a"; // Sunday font color
...
var gcToggle = "#8ebdd9"; // the highlight color for the focused cell
