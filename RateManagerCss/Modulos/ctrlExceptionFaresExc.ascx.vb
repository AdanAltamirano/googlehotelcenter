...
Partial Public Class ctrlExceptionFaresExc
...
#Region "FILL DE LOS NUEVOS DATAGRIDS"
    Private Sub FillDatas()
        ...
        datRestrictions = CType(Me.Page, FaresCataloguePromo).GetFareRestrictions
        If Not datRestrictions Is Nothing Then
            For Each dr As DataRow In datRestrictions.Tables(datRestrictions.FARESRESTRICTIONEXC_TABLE).Rows
...
#End Region
            ...
            For Each item2 As DataGridItem In dgChild.Items
                ...
                If dgTeen.Items.Count > 0 Then
                    ...
                    If Not txtTeenFare Is Nothing Then
                        ...
                        dr("TarifaAdolescenteExc") = dPrecio 'If(Not String.IsNullOrEmpty(txtTeenFare.Text), CDbl(txtTeenFare.Text), 0)
                    End If
    ...
    Private Sub dgTeen_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgTeen.ItemDataBound
        ...
        lblTemp = e.Item.Cells(0).FindControl("lblTeen")
        valChd = e.Item.Cells(1).FindControl("valTeenExtraPrice")
        If Not valChd Is Nothing Then valChd.Text = PortalCulture.GetString("00240")

        If Not txtTeenFare Is Nothing AndAlso lblTemp.Text <= 0 Then
            txtTeenFare.Text = 0
