<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrRateAplicationNRpromo.ascx.vb"
    Inherits="RateManager.ctrRateAplicationNRpromo" %>
<%@ Import Namespace="RateManager" %>
<%@ Register TagPrefix="uc1" TagName="CtrlIdioma" Src="CtrlIdioma.ascx" %>

<script runat="server">
    Protected Sub AlCargar(sender As Object, e As EventArgs) Handles MyBase.Load
...
<table id="Table1" cellspacing="1" cellpadding="1" width="100%" border="0">
    <tr>
        <td valign="middle" colspan="2" rowspan="2" style="height: 49px">
            ...
            <table id="Table3" cellspacing="1" cellpadding="0" width="100%" border="0">
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblApplyDays" runat="server" CssClass="clsLabel" EnableViewState="False"
        ...
        <td>
            <asp:Image ID="imgAddDate" Style="cursor: pointer" runat="server" ImageUrl="../Images/agregafecha.jpg"></asp:Image>
        </td>
    ...
    <tr>
        <td style="height: 13px">
            <asp:Image ID="imgDeleteDate" Style="cursor: pointer" runat="server" ImageUrl="../Images/eliminarfecha.jpg"></asp:Image>
        </td>
    </tr>
        ...
        <td colspan="6" align="center" valign="top">
            <div id="DivPromotionAndWindow" runat="server" align="center">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td rowspan="2" valign="top" style="width: 25%; text-align: right; padding-top: 5px;">
                            <asp:Label ID="lblPromotion" EnableViewState="False" runat="server" CssClass="clsLabel">Promotion : </asp:Label></td>
                        <td valign="top" style="width: 25%;">
                            <asp:TextBox Style="vertical-align: middle;" ID="txtDescProm" CssClass="textbox" runat="server" MaxLength="5" Width="48px"></asp:TextBox>
                            <asp:Label ID="lblDesc" EnableViewState="False" runat="server" CssClass="clsLabel">%</asp:Label>
                        </td>
                    ...
                    <tr>
                        <td rowspan="2" valign="top" style="text-align: right; padding-top: 5px;">
                            <asp:Label ID="lblFreeDays" runat="server" EnableViewState="False" CssClass="clsLabel">Noches Gratis : </asp:Label></td>
                        <td valign="top">
                ...
                <table cellspacing="1" cellpadding="1" width="100%" border="0">
                    <tr>
                        ...
                        <td width="20%">
                            ...
                            <asp:RangeValidator ID="RangeValidator6" runat="server" CssClass="Validators" MinimumValue="0" MaximumValue="255" Type="Integer" ControlToValidate="txtMaxAdvBooking" ErrorMessage="0-255" ForeColor="Black" Display="Dynamic"></asp:RangeValidator>
                        </td>
    ...
    <tr>
        <td colspan="6">
                ...
                <table width="100%" style="vertical-align: top;">
                    <tr id="pnlNetRates">
                        <td align="left" width="33%" valign="top">
                            ...
                            <asp:TextBox ID="txtAdultFareNR" runat="server" CssClass="TextBox currency"
                            ...
                            <asp:RangeValidator ID="RangeValidator5" runat="server" ControlToValidate="txtAdultFareNR" MinimumValue="1" MaximumValue="99999"
                        ...
                        <td align="left" width="33%" valign="top">
                            ...
                            <asp:TextBox ID="txtChildFareNR" runat="server" CssClass="TextBox currency"
                                Columns="10" MaxLength="10">0</asp:TextBox>
                            <input type="hidden" id="varChildFareNR" runat="server" class="rate" />
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqChildFareNR" runat="server" CssClass="Validators"
                                Display="Dynamic" ForeColor=" " ErrorMessage="*" ControlToValidate="txtChildFareNR"></asp:RequiredFieldValidator>
                        ...
                        <td align="left" width="33%" valign="top">
                            ...
                            <asp:TextBox ID="txtTeenFareNR" runat="server" CssClass="TextBox currency"
                                Columns="10" MaxLength="10">0</asp:TextBox>
                            <% If txtTeenFareNR.Visible Then%>
                            <input type="hidden" id="varTeenFareNR" runat="server" class="rate" />
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqTeenFareNR" runat="server" CssClass="Validators"
                                Display="Dynamic" ForeColor=" " ErrorMessage="*" ControlToValidate="txtTeenFareNR"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="valTeenPriceNr" runat="server" CssClass="Validators"
                    ...
                    <tr>
                        <td align="left" valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqAdultFare" ForeColor=" " CssClass="Validators" runat="server"
                                ControlToValidate="txtAdultFare" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator
                                ID="RVPrecio" CssClass="Validators" runat="server" ControlToValidate="txtAdultFare"
                                ErrorMessage="Precio Inválido" Display="Dynamic" ForeColor=" " ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox ID="txtChildFare" CssClass="TextBox currency" runat="server" MaxLength="10"
                                Columns="10">0</asp:TextBox>
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqChildFare" CssClass="Validators" runat="server"
                                ControlToValidate="txtChildFare" ErrorMessage="*" ForeColor=" " Display="Dynamic"></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                    ID="Regularexpressionvalidator1" CssClass="Validators" runat="server" ControlToValidate="txtChildFare"
                                    ErrorMessage="Precio Inválido" Display="Dynamic" ForeColor=" " ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                        ...
                        <td align="left" valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqTeenFare" ForeColor=" " CssClass="Validators" runat="server"
                                ControlToValidate="txtTeenFare" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="valTeenPrice" CssClass="Validators" runat="server" ControlToValidate="txtTeenFare"
                                ErrorMessage="Precio Inválido" Display="Dynamic" ForeColor=" " ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                ...
                <table width="100%" style="vertical-align: top;">
                    <tr>
                        <td align="left" width="33%" valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqExtraAdultPriceNR" ForeColor=" " CssClass="Validators" runat="server"
                                ControlToValidate="txtExtraAdultPriceNR" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                        ...
                        <td align="left" width="33%" valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqExtraChildPriceNR" ForeColor=" " CssClass="Validators" runat="server"
                                ControlToValidate="txtExtraChildPriceNR" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                        ...
                        <td width="33%" valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqExtraTeenPriceNR" ForeColor=" " CssClass="Validators" runat="server"
                                ControlToValidate="txtExtraTeenPriceNR" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td align="left" valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqExtraAdultPrice" ForeColor=" " CssClass="Validators" runat="server"
                        ...
                        <td align="left" valign="top">
                            <asp:TextBox ID="txtExtraChildPrice" runat="server" CssClass="TextBox currency" Columns="10"
                                MaxLength="10"></asp:TextBox>
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqExtraChildPrice" ForeColor=" " CssClass="Validators" runat="server"
                            ...
                            <asp:RegularExpressionValidator ID="valExtraChildPrice" runat="server" CssClass="Validators"
                                ...
                                ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                            <asp:CompareValidator ID="compExtraChildPrice" runat="server" CssClass="Validators" ErrorMessage="CompareValidator" ControlToValidate="txtExtraChildPrice"
                                ControlToCompare="txtExtraChildPriceNR" Type="Double" Operator="GreaterThanEqual" Display="Dynamic" Style="width: 120px;"><%= RateManager.PortalCulture.GetString("01506") %></asp:CompareValidator>
                        ...
                        <td valign="top">
                            ...
                            <span class="currency"></span>
                            <asp:RequiredFieldValidator ID="reqExtraTeenPrice" ForeColor=" " CssClass="Validators" runat="server"
                            ...
                            <asp:RegularExpressionValidator ID="valExtraTeenPrice" runat="server" CssClass="Validators"
                                ...
                                ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                            <asp:CompareValidator ID="compExtraTeenPrice" runat="server" CssClass="Validators" ErrorMessage="CompareValidator" ControlToValidate="txtExtraTeenPrice"
                                ControlToCompare="txtExtraTeenPriceNR" Type="Double" Operator="GreaterThanEqual" Display="Dynamic" Style="width: 120px;"><%= RateManager.PortalCulture.GetString("01506") %></asp:CompareValidator>
            ...
            <div>
                <span class="validators" id="lblNetRateExceded" runat="server" style="display: none;"></span>
            </div>
            <%End If%>
