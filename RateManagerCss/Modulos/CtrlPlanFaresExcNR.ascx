<%@ Control Language="vb" AutoEventWireup="false" Codebehind="CtrlPlanFaresExcNR.ascx.vb" Inherits="RateManager.CtrlPlanFaresExcNR" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
