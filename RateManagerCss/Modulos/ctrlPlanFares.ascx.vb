...
#End Region
    ...
    Public Property dsRest() As FaresRestrictionsData
        Get
            Return ViewState("dsRest")
        End Get
        Set(ByVal Value As FaresRestrictionsData)
            ViewState("dsRest") = Value
        End Set
    End Property
    Public Property isConfigAdolescente() As Integer
        Get
            If ViewState("_isConfigAdolescente") Is Nothing Then
                Return -1
            Else
                Return ViewState("_isConfigAdolescente")
            End If
        End Get
        Set(ByVal value As Integer)
            ViewState("_isConfigAdolescente") = value
        End Set
    End Property
...
#Region "FILL DE LOS NUEVOS DATAGRIDS"
    Private Sub FillDatas()
        ...
        If Not datRestrictions Is Nothing Then
            ...
            If isConfigAdolescente = 1 Or (isConfigAdolescente = -1 AndAlso CType(Me.Page, PaginaBase).isConfigAdolescente) Then
...
#Region "METODOS  y  PROCEDIMIENTOS"
    ...
    Function Nota(ByVal rp As String, ByRef sference As String) As String
        ...
        If drhotel Is Nothing Then Return "Grupos"
    ...
    Sub Addrateplan(ByVal ds As FaresRestrictionsData, ByVal field As String, ByVal valor As String)
    ...
    Public Function Save(ByVal rp As String, ByVal sroom As String, ByVal sPeticionCorreo As String, Optional ByVal dt As DataTable = Nothing, Optional ByVal RateId As String = "") As Boolean
        Dim validate As Boolean = True
        ...
        'sdato = Util.Utility.GetXml(datRestrictions.FARESRESTRICTION_TABLE, "UpdateRateRestriction", datRestrictions)
        For i = 0 To datRestrictions.Tables(FaresRestrictionsData.FARESRESTRICTION_TABLE).Rows.Count - 1
            Dim chkActivo As CheckBox
            ...
            With datRestrictions.Tables(FaresRestrictionsData.FARESRESTRICTION_TABLE)
                ...
                If Not txtChildFare Is Nothing Then
                    ...
                    If .Rows(i)(FaresRestrictionsData.CHILDFARE_FIELD) <> dPrecio Then
                        .Rows(i)(FaresRestrictionsData.CHILDFARE_FIELD) = dPrecio
                    End If
                End If
                ...
                If Not txtTeenFare Is Nothing Then
                    ...
                    If .Rows(i)(FaresRestrictionsData.TEENFARE_FIELD) <> dPrecio Then
                        .Rows(i)(FaresRestrictionsData.TEENFARE_FIELD) = dPrecio
                    End If
                End If
                ...
                If Not txtChildFare Is Nothing Then
                    Double.TryParse(txtChildFare.Text, dPrecio)
                    .Rows(i)(FaresRestrictionsData.CHILDFARE_FIELD) = dPrecio 'Double.Parse(txtChildFare.Text)
                Else
                ...
                If Not txtTeenFare Is Nothing Then
                    Double.TryParse(txtTeenFare.Text, dPrecio)
                    .Rows(i)(FaresRestrictionsData.TEENFARE_FIELD) = dPrecio 'Double.Parse(txtTeenFare.Text)
                Else
        ...
        If validate Then
            With New FaresRestrictionSystem
                ...
                If Save Then
                    ...
                    sdato = Util.Utility.GetXml(datRestrictions.FARESRESTRICTION_TABLE, "UpdateRateRestriction", dsRest)

                    Addrateplan(datRestrictions, "Descr_rateplan", String.Format("{0}/ {1}", rp, sroom))
                    sdatoDespues = Util.Utility.GetXml(datRestrictions.FARESRESTRICTION_TABLE, "UpdateRateRestriction", datRestrictions)
                    ...
                    sPeticionCorreo = sPeticionCorreo + sdatoCorreo
                    ...
                    CType(Me.Page, PaginaBase).guardalog("/Pages/FaresCatalogue.aspx", PaginaBase.acciones.Modificar, snota, sreference & " " & CType(Me.Page, PaginaBase).cInfoActual.HotelName, sdato, sdatoDespues, sPeticionCorreo)
