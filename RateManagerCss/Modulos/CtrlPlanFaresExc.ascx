<%@ Control Language="vb" AutoEventWireup="false" Codebehind="CtrlPlanFaresExc.ascx.vb" Inherits="RateManager.CtrlPlanFaresExc" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<TABLE id="Table3" cellSpacing="2" cellPadding="0" width="100%" border="0">
	...
	<TR>
		<TD vAlign="top" align="center" ><asp:datagrid id="dgAdult" runat="server" CssClass="DataGrid" AutoGenerateColumns="False" Width="100%">
				...
				<HeaderStyle CssClass="dgHeader"></HeaderStyle>
				<Columns>
					<asp:TemplateColumn HeaderText="Adultos" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="center"  >
						<ItemTemplate  >												    
		...
		<asp:datagrid id="dgTeen" runat="server" CssClass="DataGrid" AutoGenerateColumns="False" Width="100%">
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="Tarifa de ni&#241;os">
						<HeaderTemplate>
							<asp:Label id="lblHeader4" runat="server">Tarifa de Adolescentes</asp:Label>
						</HeaderTemplate>
						<ItemTemplate>
							...
							<span class="currency"></span>
							<asp:CustomValidator id="cvErrTeen" Display="Dynamic" runat="server" ControlToValidate="txtTeenFare">*</asp:CustomValidator><BR>
