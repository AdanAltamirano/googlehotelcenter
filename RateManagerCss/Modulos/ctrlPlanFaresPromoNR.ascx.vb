        ...
        If Not datRestrictions Is Nothing Then
            For Each dr As DataRow In datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTIONEXC_TABLE).Rows
                If dr(FaresRestrictionsDataExc.ADULTNUMBER_FIELD) <> ad Then
                    ...
                    drnew("PriceNR") = IIf(dr(FaresRestrictionsDataExc.ADULTFARENR_FIELD) Is DBNull.Value, 0, dr(FaresRestrictionsDataExc.ADULTFARENR_FIELD))
                ...
                If dr(FaresRestrictionsDataExc.CHILDNUMBER_FIELD) > 0 AndAlso strch.IndexOf("," & dr(FaresRestrictionsDataExc.CHILDNUMBER_FIELD) & ",") = -1 Then
                    ...
                    drnew("PriceNR") = IIf(dr(FaresRestrictionsDataExc.CHILDFARENR_FIELD) Is DBNull.Value, 0, dr(FaresRestrictionsDataExc.CHILDFARENR_FIELD))
                    drnew(FaresRestrictionsDataExc.PKIDRESTRICTION_FIELD) = dr(FaresRestrictionsDataExc.PKIDRESTRICTION_FIELD)
                    ...
                    drnew("PriceNR") = IIf(dr(FaresRestrictionsDataExc.TEENFARENR_FIELD) Is DBNull.Value, 0, dr(FaresRestrictionsDataExc.TEENFARENR_FIELD))
                    drnew(FaresRestrictionsDataExc.PKIDRESTRICTION_FIELD) = dr(FaresRestrictionsDataExc.PKIDRESTRICTION_FIELD)
...
#Region "METODOS  y  PROCEDIMIENTOS"
    ...
    Private Sub FillDataGrid()
        ...
        datRestrictions = GetFareRestrictions()
        'If Not datRestrictions Is Nothing Then
        '    dtgRestrictions.DataSource = datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTION_TABLE)
        'End If
            ...
            For idxChild = 0 To iChild
                ...
                Else
                    ...
                    With newRow
                        ...
                        .Item(FaresRestrictionsDataExc.ADULTFARENR_FIELD) = iPriceRoomNR
                        ...
                        .Item(FaresRestrictionsDataExc.CHILDFARENR_FIELD) = iPriceExtraChildNR '* idxChild
                        ...
                        .Item(FaresRestrictionsDataExc.EXCADULTFARENR_FIELD) = 0 'iPriceRoomExc
                        .Item(FaresRestrictionsDataExc.EXCNINIOFARENR_FIELD) = 0 'iPriceExtraChildExc * idxChild
    ...
    Public Function IsValidData() As Boolean
        ...
        For Each item As DataGridItem In dgAdult.Items
            ...
            '   IsValidData = IsValidData AndAlso (netRate * (1 + (minPercent / 100)) < rate OrElse netRate * (1 + (maxPercent / 100)) > rate)
    ...
    Private Function RowInPlan(ByVal datRestrictions As FaresRestrictionsDataExc, ByVal iAdults As Integer, ByVal iChildren As Integer) As DataRow
        Dim row As DataRow
        For Each row In datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTIONEXC_TABLE).Rows
            If row(FaresRestrictionsDataExc.ADULTNUMBER_FIELD) = iAdults And _
            row(FaresRestrictionsDataExc.CHILDNUMBER_FIELD) = iChildren Then
                Return row
            End If
        Next
        Return Nothing
    ...
    '    For i = 0 To datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTION_TABLE).Rows.Count - 1
    ...
    '        With datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTION_TABLE)
    ...
    Function getDataXML(ByVal ds As DataSet, ByVal descrPlan As String, ByVal iscreate As Boolean) As String
        ...
        Return Util.Utility.GetXml(FaresRestrictionsDataExc.FARESRESTRICTIONEXC_TABLE, "UpdatePlanFaresNR", ds)
    End Function
    ...
    Public Function Save(ByVal rp As String, ByVal sroom As String, ByVal scorreo As String, Optional ByVal dt As DataTable = Nothing) As Boolean
        Dim validate As Boolean = True
        Dim datRestrictions As FaresRestrictionsDataExc = GetFareRestrictions()
        Dim datPrev As FaresRestrictionsDataExc = GetFareRestrictions()
        'Dim row As DataRow
        Dim i As Integer
        Dim Ad As Integer
        Dim Ch As Integer
        ...
        sDataPrev = getDataXML(datRestrictions, String.Format("{0}/ {1}", rp, sroom), True)
        ...
        For i = 0 To datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTIONEXC_TABLE).Rows.Count - 1
            ...
            With datRestrictions.Tables(FaresRestrictionsDataExc.FARESRESTRICTIONEXC_TABLE)
                ...
                ' si se ha modificado el registro entonces lo marcamos como modified
                If IIf(.Rows(i)(FaresRestrictionsDataExc.ADULTFARENR_FIELD) Is DBNull.Value, 0, .Rows(i)(FaresRestrictionsDataExc.ADULTFARENR_FIELD)) <> Double.Parse(txtAdultFareNR.Text) Then
                    .Rows(i)(FaresRestrictionsDataExc.ADULTFARENR_FIELD) = Double.Parse(txtAdultFareNR.Text)
                End If
                ...
                If Not txtChildFareNR Is Nothing Then
                    If IIf(.Rows(i)(FaresRestrictionsDataExc.CHILDFARENR_FIELD) Is DBNull.Value, 0, .Rows(i)(FaresRestrictionsDataExc.CHILDFARENR_FIELD)) <> Double.Parse(txtChildFareNR.Text) Then
                        .Rows(i)(FaresRestrictionsDataExc.CHILDFARENR_FIELD) = Double.Parse(txtChildFareNR.Text)
                    End If
                End If
                ...
                If Not txtTeenFareNR Is Nothing Then
                    If IIf(.Rows(i)(FaresRestrictionsDataExc.TEENFARENR_FIELD) Is DBNull.Value, 0, .Rows(i)(FaresRestrictionsDataExc.TEENFARENR_FIELD)) <> Double.Parse(txtTeenFareNR.Text) Then
                        .Rows(i)(FaresRestrictionsDataExc.TEENFARENR_FIELD) = Double.Parse(txtTeenFareNR.Text)
                    End If
                End If
                ...
                If Not txtChildFareNR Is Nothing Then
                    .Rows(i)(FaresRestrictionsDataExc.CHILDFARENR_FIELD) = Double.Parse(txtChildFareNR.Text)
                Else
                    .Rows(i)(FaresRestrictionsDataExc.CHILDFARENR_FIELD) = 0
                End If
                .Rows(i)(FaresRestrictionsDataExc.ADULTFARENR_FIELD) = Double.Parse(txtAdultFareNR.Text)
                ...
                If Not txtTeenFareNR Is Nothing Then
                    .Rows(i)(FaresRestrictionsDataExc.TEENFARENR_FIELD) = Double.Parse(txtTeenFareNR.Text)
                Else
                    .Rows(i)(FaresRestrictionsDataExc.TEENFARENR_FIELD) = 0
                End If
                If Not txtTeenFare Is Nothing Then
                    .Rows(i)(FaresRestrictionsDataExc.TEENFARE_FIELD) = Double.Parse(txtTeenFare.Text)
                Else
                ...
                If Not dt Is Nothing Then
                    ...
                    .Rows(i)(FaresRestrictionsDataExc.EXCADULTFARENR_FIELD) = dt.Rows(i)(FaresRestrictionsDataExc.EXCADULTFARENR_FIELD)
                    .Rows(i)(FaresRestrictionsDataExc.EXCNINIOFARENR_FIELD) = dt.Rows(i)(FaresRestrictionsDataExc.EXCNINIOFARENR_FIELD)
                    .Rows(i)(FaresRestrictionsDataExc.EXTEENFARENR_FIELD) = dt.Rows(i)(FaresRestrictionsDataExc.EXTEENFARENR_FIELD)
                Else
                    .Rows(i)(FaresRestrictionsDataExc.EXCADULTFARE_FIELD) = 0
                    .Rows(i)(FaresRestrictionsDataExc.EXCNINIOFARE_FIELD) = 0
                    .Rows(i)(FaresRestrictionsDataExc.EXTEENFARE_FIELD) = 0

                    .Rows(i)(FaresRestrictionsDataExc.EXCADULTFARENR_FIELD) = 0
                    .Rows(i)(FaresRestrictionsDataExc.EXCNINIOFARENR_FIELD) = 0
                    .Rows(i)(FaresRestrictionsDataExc.EXTEENFARENR_FIELD) = 0
                End If
                'Else    ' si no está habilitado el registro pero si existía antes
                '    If Me.dtgRestrictions.Items(i).Cells(RestrictionsDtgCols.RestrictionId).Text <> 0 Then       'Es delete
                '        .Rows(i).Delete()
        ...
        If validate Then
            ...
            With New FaresRestrictionException
                ...
                If Save Then
                    ...
                    scorreo = scorreo + sdatoCorreo

                    CType(Me.Page, PaginaBase).guardalog("/Pages/FaresCataloguePromoNR.aspx", PaginaBase.acciones.Modificar, _
                        "Se modificó la tarifa promocion NR de la habitación con el rateplan " & FaresRestrictionsDataExc.IDFARE_FIELD, "", sDataPrev, sData, scorreo)
    ...
    Function GeneraCorreoXslt(ByVal sDatos As String, ByVal sDatosDespues As String) As String
    ...
    Public Function CreateRPDHtml(ByVal dsBefore As DataSet, ByVal dsFares As DataSet, ByRef hr As Boolean) As String
