...
Partial Class CtrlPlanFaresExc
...
#Region "FILL DE LOS NUEVOS DATAGRIDS"
    Private Sub FillDatas()
        ...
        ElseIf TypeOf (Me.Page) Is Groups Then
            datRestrictions = CType(Me.Page, Groups).GetFareRestrictions
        Else
            Return
        End If
...
#End Region
    ...
    Public Function getRatesExceptions() As DataTable
        ...
        For Each item As DataGridItem In dgAdult.Items
            ...
            Double.TryParse(txtAdultFare.Text, dPrecio)
            dr("TarifaAdultoExc") = dPrecio ''CDbl(txtAdultFare.Text)
            dr("TarifaNinioExc") = 0
            ...
            For Each item2 As DataGridItem In dgChild.Items
                ...
                If dgTeen.Items.Count > 0 Then
                    ...
                    dr("TarifaAdolescenteExc") = dPrecio
                End If
                ...
                '        dr("TarifaAdolescenteExc") = If(Not String.IsNullOrEmpty(txtTeenFare.Text), CDbl(txtTeenFare.Text), 0)
                '    End If
