<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrRateAplicationExc.ascx.vb"
    Inherits="RateManager.ctrRateAplicationExc" %>
...
<table id="Table1" border="0" cellspacing="1" cellpadding="1" width="100%">
    <tr>
        <td style="height: 49px" valign="middle" rowspan="2" colspan="2">
            ...
            <table id="Table3" border="0" cellspacing="1" cellpadding="0" width="100%">
                ...
                <tr>
                <td><asp:Label ID="lblApplyDays" runat="server" CssClass="clsLabel" EnableViewState="False"
                Text="Dias que aplica"></asp:Label></td>
                <td>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lblDomingo1" runat="server" CssClass="clsLabel" EnableViewState="False">Dom</asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblLunes1" runat="server" CssClass="clsLabel" EnableViewState="False">Lu</asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblMartes1" runat="server" CssClass="clsLabel" EnableViewState="False">Mar</asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblMiercoles1" runat="server" CssClass="clsLabel" EnableViewState="False">Mier</asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblJueves1" runat="server" CssClass="clsLabel" EnableViewState="False">Jue</asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblViernes1" runat="server" CssClass="clsLabel" EnableViewState="False">Vi</asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblSabado1" runat="server" CssClass="clsLabel" EnableViewState="False">Sab</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:CheckBox ID="ChkApp7" runat="server"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="ChkApp1" runat="server"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="ChkApp2" runat="server"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="ChkApp3" runat="server"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="ChkApp4" runat="server"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="ChkApp5" runat="server"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="ChkApp6" runat="server"></asp:CheckBox>
                        </td>
                    </tr>
                </table>
                </td>
        ...
        <td style="height: 49px" valign="middle" rowspan="2" colspan="2" align="left">
            <table border="0" cellspacing="1" cellpadding="1" width="100%">
                <tr>
                    <td>
                        <asp:Label ID="lblStartDate" runat="server" CssClass="clslabel" EnableViewState="False">Desde:</asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtDateFrom" runat="server" Width="84px" CssClass="textbox" Columns="10"
                            MaxLength="10"></asp:TextBox><a hidefocus onclick="if(self.gfPop)gfPop.fPopCalendar(document.getElementById('<%response.write(txtDateTo.ClientId)%>'),document.getElementById('<%response.write(txtDateFrom.ClientId)%>'));return false;"
                                href="javascript:void(0)"><img class="PopcalTrigger" border="0" alt="" align="absMiddle"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDateTo" runat="server" Width="84px" CssClass="textbox" Columns="10"
                            MaxLength="10"></asp:TextBox><a hidefocus onclick="if(self.gfPop)gfPop.fPopCalendar1(document.getElementById('<%response.write(txtDateTo.ClientId)%>'));return false;"
                                href="javascript:void(0)"><img class="PopcalTrigger" border="0" alt="" align="absMiddle"
        ...
        <td>
            <asp:Image Style="cursor: pointer" ID="imgAddDate" runat="server" ImageUrl="../Images/agregafecha.jpg">
            </asp:Image>
        </td>
        <td style="height: 49px" valign="top" rowspan="2" width="20%" align="left">
            <asp:ListBox ID="lstDates" runat="server" CssClass="clslabel" EnableViewState="True" style="height:80px; width:160px;">
            </asp:ListBox>
        </td>
    </tr>
    <tr>
        <td style="height: 13px">
            <asp:Image Style="cursor: pointer" ID="imgDeleteDate" runat="server" ImageUrl="../Images/eliminarfecha.jpg">
            </asp:Image>
        </td>
    </tr>
    <tr>
        <td colspan="6" align="center">
            <asp:Label ID="lblDateError" runat="server" CssClass="Validators" EnableViewState="False"
    ...
    <tr>
        <td class="dgItem" colspan="6" align="center">
            <asp:Label ID="lblProWin" runat="server" CssClass="clsLabel" EnableViewState="False">Promociones</asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="6" align="right">
            <asp:HyperLink ID="hplShowProWin" runat="server" CssClass="showOptions">Mostrar</asp:HyperLink><asp:HyperLink
                ID="hplHideProWin" runat="server" CssClass="hideOptions">Ocultar</asp:HyperLink>
        </td>
    </tr>
    <tr>
        <td valign="top" colspan="6" align="center">
            <div id="DivPromotionAndWindow" align="center" runat="server">
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="right" valign="top" style="width:25%; padding-top:5px;" rowspan="2">
                    ...
                    <tr>
                        <td>
                            <asp:RangeValidator Style="z-index: 0" ID="RVPromotion" runat="server" CssClass="validators"
                                MinimumValue="0" MaximumValue="100" Type="Double" ControlToValidate="txtDescProm"
                                ErrorMessage="Descuento debe ser numerico" Display="Dynamic"></asp:RangeValidator>
                            <asp:RangeValidator Style="z-index: 0" ID="Rangevalidator4" runat="server" CssClass="Validators"
                                MinimumValue="0" Display="Dynamic" MaximumValue="100" Type="Double" ControlToValidate="txtDescProm"
                                ErrorMessage="0-100"></asp:RangeValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" style="padding-top:5px;" rowspan="2">
                            <asp:Label ID="lblFreeDays" runat="server" EnableViewState="False" CssClass="clsLabel">Noches Gratis :</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDaysFree" runat="server" Width="48px" CssClass="textbox" MaxLength="3"></asp:TextBox>
                        </td>
                    </tr>	
                    <tr>
                        <td>
                            <asp:RegularExpressionValidator ID="rxvDaysfree" runat="server" CssClass="Validators"
                                ControlToValidate="txtDaysFree" ErrorMessage="Precio Inválido" ForeColor=" "
                                Display="Dynamic" ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" valign="top" style="padding-top:5px;" class="clsLabel"><%=RateManager.PortalCulture.GetString("01399", True)%></td>
                        <td>
    ...
    <tr>
        <td class="dgItem" colspan="6" align="center">
            <asp:Label ID="lblWinReserva" runat="server" CssClass="clsLabel" EnableViewState="False">Ventana de Reserva</asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="6" align="right">
            <asp:HyperLink ID="hplShowVentanaReserva" runat="server" CssClass="showOptions">Mostrar</asp:HyperLink><asp:HyperLink
                ID="hplHideVentanaReserva" runat="server" CssClass="hideOptions">Ocultar</asp:HyperLink>
        </td>
    </tr>
    <tr>
        <td align="center" colspan="6">
            <div id="DivWindowBooking" align="center" runat="server">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="left">
                            <table id="tbBookingWindow" border="0" cellspacing="1" cellpadding="1" width="100%"
                                runat="server">
                                <tr>
                                    <td>
                                        <asp:Label ID="lblBookWindowStartDate" runat="server" CssClass="clslabel" EnableViewState="False">Desde:</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBookWindowDateFrom" runat="server" Width="75px" CssClass="textbox"
                                            Columns="10" MaxLength="10"></asp:TextBox><a hidefocus onclick="if(self.gfPop)gfPop.fPopCalendar(document.getElementById('<%response.write(txtBookWindowDateTo.ClientId)%>'),document.getElementById('<%response.write(txtBookWindowDateFrom.ClientId)%>'));return false;"
                                                href="javascript:void(0)"><img class="PopcalTrigger" border="0" alt="" align="absMiddle"
                                                    src='<%=GeRequestApplicationPath("/Calendar/calbtn.gif")%>'></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblBookWindowEndDate" runat="server" CssClass="clsLabel" EnableViewState="False">Hasta:</asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBookWindowDateTo" runat="server" Width="75px" CssClass="textbox"
                                            Columns="10" MaxLength="10"></asp:TextBox><a hidefocus onclick="if(self.gfPop)gfPop.fPopCalendar1(document.getElementById('<%response.write(txtBookWindowDateTo.ClientId)%>'));return false;"
                                                href="javascript:void(0)"><img class="PopcalTrigger" border="0" alt="" align="absMiddle"
                                                    src='<%=GeRequestApplicationPath("/Calendar/calbtn.gif")%>'>
                                            </a>
                                    </td>
    ...
    <tr>
        <td class="dgItem" colspan="6" align="center">
            <asp:Label ID="lblOccupation" runat="server" CssClass="clsLabel" EnableViewState="False">Ocupación por habitación</asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="6" align="right">
            <asp:HyperLink ID="hplShowOccupation" runat="server" CssClass="showOptions">Mostrar</asp:HyperLink><asp:HyperLink
                ID="hplHideOccupation" runat="server" CssClass="hideOptions">Ocultar</asp:HyperLink>
        </td>
    </tr>
    <tr>
        <td valign="top" colspan="6" align="center">
            <div id="DivOccupation" align="center" runat="server">
                ...
                <table border="0" cellspacing="5" cellpadding="0">
                    <tr>
                        <td align="right">
                            <asp:Label ID="lbPersonas" runat="server" CssClass="clslabel" EnableViewState="False">Personas:</asp:Label>
                        </td>
                        <td align="left">
                        ...
                        <td align="right">
                            <asp:Label ID="lblNumberAdults" runat="server" CssClass="clslabel" EnableViewState="False">Maximo Adultos:</asp:Label>
                        </td>
                        <td>
    ...
    <tr>
        <td class="dgItem" colspan="6" align="center">
            <asp:Label ID="lblReservationRules" runat="server" CssClass="clsLabel" EnableViewState="False">Precios de tarifa</asp:Label>
        </td>
    </tr>
    <tr>
        <td colspan="5" align="left">
            <asp:CheckBox ID="chkRules" runat="server" CssClass="clsLabel"></asp:CheckBox>
        </td>
        <td align="right">
            <asp:HyperLink ID="hplShowRules" runat="server" CssClass="showOptions">Show Rules</asp:HyperLink><asp:HyperLink
                ID="hplHideRules" runat="server" CssClass="hideOptions">Hide Rules</asp:HyperLink>
        </td>
    </tr>
    <tr>
        <td colspan="6">
                ...
                <table border="0" cellspacing="1" cellpadding="1" width="100%">
                    <tr>
                        <td width="30%" align="right">
                            <asp:Label ID="lblAdvBooking" runat="server" CssClass="clsLabel" EnableViewState="False">Advanced Booking:</asp:Label>
                        </td>
                        <td width="20%">
                            ...
                            <asp:RangeValidator ID="RangeValidator1" runat="server" CssClass="Validators" MinimumValue="0" MaximumValue="255"
                                Type="Integer" ControlToValidate="txtAdvBooking" ErrorMessage="0-255" ForeColor="Black"
                        ...
                        <td width="20%" align="right">
                            <asp:Label ID="lblNoArrivos" runat="server" CssClass="clsLabel" EnableViewState="False">No Arrivos:</asp:Label>
                        </td>
                        <td width="30%">
                            <table id="Table2" border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblMartes" runat="server" CssClass="clsLabel" EnableViewState="False">Mar</asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblMiercoles" runat="server" CssClass="clsLabel" EnableViewState="False">Mier</asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblJueves" runat="server" CssClass="clsLabel" EnableViewState="False">Jue</asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblViernes" runat="server" CssClass="clsLabel" EnableViewState="False">Vi</asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblSabado" runat="server" CssClass="clsLabel" EnableViewState="False">Sab</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblMinDias" runat="server" CssClass="clsLabel" EnableViewState="False">Minimo de noches para reservar:</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtMinDias" runat="server" Width="40px" CssClass="TextBox" MaxLength="3"></asp:TextBox><asp:RangeValidator
                                ID="RangeValidator2" runat="server" CssClass="Validators" MinimumValue="1" MaximumValue="255"
                                Type="Integer" ControlToValidate="txtMinDias" ErrorMessage="1-255" ForeColor="Black"
                                Display="Dynamic"></asp:RangeValidator>
                        </td>
                        <td align="right">
                            <asp:Label ID="lblMaxDias" runat="server" CssClass="clsLabel" EnableViewState="False">Maximo  de noches para reservar</asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtMaxDias" runat="server" Width="32px" CssClass="TextBox" MaxLength="3"></asp:TextBox><asp:RangeValidator
                                ID="RangeValidator3" runat="server" CssClass="Validators" MinimumValue="0" MaximumValue="255"
                                Type="Integer" ControlToValidate="txtMaxDias" ErrorMessage="0-255" ForeColor="Black"
                                Display="Dynamic"></asp:RangeValidator>
                        </td>
                    </tr>
                    <tr>
        ...
        <div id="pnlTarifas" style="display:inline; width:49%; vertical-align:top;"> 
            <table width="100%" style="vertical-align:top;">
                <tr>
                    ...
                    <td align="left" width="33%">
                        <asp:Label ID="lblAdolescentePrice" runat="server" CssClass="clsLabel" EnableViewState="False">Adolescente</asp:Label>
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="top">
                        ...
                        <asp:RequiredFieldValidator ID="reqAdultFare" runat="server" CssClass="Validators"
                            ControlToValidate="txtAdultFare" ErrorMessage="*" Display="Dynamic" ForeColor=" "></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RVPrecio" runat="server" CssClass="Validators"
                            ControlToValidate="txtAdultFare" ErrorMessage="Precio Inválido" ForeColor=" "
                            Display="Dynamic" ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                    </td>
                    <td align="left" valign="top">
                        <asp:TextBox ID="txtChildFare" runat="server" CssClass="TextBox currency" Columns="10"
                            MaxLength="10">0</asp:TextBox>
                        <span class="currency"></span>
                        <asp:RequiredFieldValidator ID="reqChildFare" runat="server" CssClass="Validators"
                    ...
                    <td align="left" valign="top">
                        ...
                        <span class="currency"></span>
                        <asp:RequiredFieldValidator ID="reqTeenFare" ForeColor=" " runat="server" CssClass="Validators"
                            ControlToValidate="txtTeenFare" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="rxvAdoslecenteFare" runat="server" CssClass="Validators"
            ...
            <table width="100%" style="vertical-align:top;">
                ...
                <tr>
                    <td align="left" valign="top">
                        ...
                        <span class="currency"></span>
                        <asp:RequiredFieldValidator ID="reqExtraAdultPrice" ForeColor=" " runat="server" CssClass="Validators"
                            ControlToValidate="txtExtraAdultPrice" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="valAdultExtraPrice" runat="server" CssClass="Validators"
                            ControlToValidate="txtExtraAdultPrice" ErrorMessage="Precio Inválido" ForeColor=" "
                            Display="Dynamic" ValidationExpression="^([0-9]*|\d*\.\d{1}?\d*)$"></asp:RegularExpressionValidator>
                    </td>
                    <td align="left" valign="top">
                        <asp:TextBox ID="txtExtraChildPrice" runat="server" CssClass="TextBox currency" Columns="10"
                            MaxLength="10"></asp:TextBox>
                        <span class="currency"></span>
                        <asp:RequiredFieldValidator ID="reqExtraChildPrice" ForeColor=" " runat="server" CssClass="Validators"
                            ControlToValidate="txtExtraChildPrice" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                    ...
                    <td valign="top">
                        ...
                        <span class="currency"></span>
                        <asp:RequiredFieldValidator ID="reqExtraTeenPrice" ForeColor=" " runat="server" CssClass="Validators"
                            ControlToValidate="txtExtraTeenPrice" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="rxvExtraTeenprice" runat="server" CssClass="Validators"
