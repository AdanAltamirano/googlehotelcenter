<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ctrlPlanFares.ascx.vb" Inherits="RateManager.ctrlPlanFares" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
