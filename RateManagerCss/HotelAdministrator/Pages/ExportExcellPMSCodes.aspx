    ...
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Table runat="server" ID="generalTable"  >
            <asp:TableRow HorizontalAlign="center" >
                ...
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server" ID="LabelHotel" Font-Bold="true">Hotel</asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server" ></asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server"></asp:Label></asp:TableCell>
                <asp:TableCell><asp:Label runat="server"></asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server"></asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server" ID="LabelEndpoint" Font-Bold="true">EndPoint</asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server"></asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                ...
                <asp:TableCell ><asp:Label runat="server" ></asp:Label></asp:TableCell>
                <asp:TableCell HorizontalAlign="Left" Wrap="false"><asp:Label runat="server" ID="txtEndPoint">EndPoint</asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow HorizontalAlign="center" BorderColor="Black" BorderStyle="Solid">
                <asp:TableCell><asp:Label runat="server" ID="txtHotelName">Nombre</asp:Label></asp:TableCell>
                <asp:TableCell><asp:Label runat="server" ID="txtCode">Código</asp:Label></asp:TableCell>
                <asp:TableCell><asp:Label runat="server" ID="txtUser">Usuario</asp:Label></asp:TableCell>
                <asp:TableCell><asp:Label runat="server" ID="txtPass">Contraseña</asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>

        <asp:Table runat="server" ID="tblRooms" >
            <asp:TableRow>
                <asp:TableCell><asp:Label runat="server" ID="Label1"> </asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Label runat="server" ID="Label2"> </asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server"></asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server" ID="Label3" Font-Bold="true">Habitaciones</asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        ...
        <asp:Table runat="server" ID="tblPlans" >
            <asp:TableRow>
                <asp:TableCell><asp:Label runat="server" ID="ws3"> </asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell><asp:Label runat="server" ID="ws4"> </asp:Label></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server"></asp:Label></asp:TableCell>
                <asp:TableCell BackColor="#3f85c5" ForeColor="White"><asp:Label runat="server" ID="titleRP" Font-Bold="true">Planes Tarifarios</asp:Label></asp:TableCell>
            </asp:TableRow>
        </asp:Table>
