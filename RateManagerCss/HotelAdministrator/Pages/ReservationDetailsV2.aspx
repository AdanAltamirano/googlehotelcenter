...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReservationDetailsV2.aspx.vb"
    Inherits="RateManager.ReservationDetailsV2" %>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" ms_positioning="FlowLayout">
    ...
    <form id="Form1" method="post" runat="server">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:Label ID="lblEOut" runat="server" EnableViewState="False" CssClass="clsLabel">Check-Out Date :</asp:Label><asp:Label
                                    ID="lblOut" runat="server" EnableViewState="True" Font-Bold="True" CssClass="clsLabel">26 Aug 05</asp:Label><br>
                                <div>
                                    <asp:Label ID="lblEOldOut" runat="server" EnableViewState="False" CssClass="clsLabel"> Original check out:</asp:Label>
                                    <asp:Label ID="lblOldOut" runat="server" EnableViewState="False" Font-Bold="True"
                                            ...
                                            <td colspan="2">
                                                <table>
                                                    <tr id="trCancelPol" runat="server">
                                                        <td colspan="3">
                                                            <p><b>
                                                                <asp:Label ID="lblCancelPolTitle" runat="server">Cancelacion:</asp:Label></b></p>
                                                            <p>
                                                                <asp:Label ID="lblCancelationPolices" runat="server"></asp:Label></p>
                                                            <br />
                                                        </td>
                                                    </tr>
                                                    <tr id="trCardPol" runat="server">
                                                        <td colspan="3">
                                                            <p><b>
                                                                <asp:Label ID="lblCardPolTitle" runat="server">Tarjeta de credito:</asp:Label></b></p>
                                                            <p>
                                                                <asp:Label ID="lblCreditCardPolices" runat="server"></asp:Label></p>
                                                            <br />
                                                        </td>
                                                    </tr>
                                                    <tr id="trGuarPol" runat="server">
                                                        <td colspan="3">
                                                            <p><b>
                                                                <asp:Label ID="lblGuarPolTitle" runat="server">Garantias:</asp:Label></b></p>
                                                            <p>
                                                                <asp:Label ID="lblGuaranteePolices" runat="server"></asp:Label></p>
                                                            <br />
                                                        </td>
                                                    </tr>
                                                </table>
        ...
        <div id="StatusPopup" style="display: none;">
            <table id="Table8" style="border-right: #cbdced 1px solid; border-top: #cbdced 1px solid; border-left: #cbdced 1px solid; border-bottom: #cbdced 1px solid; margin: 50px;"
                cellspacing="1"
                ...
                <tr>
                    <td align="left" colspan="3" style="vertical-align: top;">
                        <div style="float: left; margin-left: 50px">
                            <asp:RadioButton runat="server" ID="noShow" GroupName="ResStatus" Text="No Show" onclick="HideOutCalendar()" /><br>
                            <br>
                            <asp:RadioButton runat="server" ID="earlyOut" GroupName="ResStatus" Text="Early Check-Out" Checked="true" onclick="showOutCalendar()" />
                        </div>
                        <div style="float: left; margin-left: 50px; width: 350px">
                            ...
                            <asp:Label ID="lblInDate" runat="server" EnableViewState="True" CssClass="clslabel">_</asp:Label><br>
                            <br>

                            <asp:Label ID="lblCheckOut" runat="server" EnableViewState="False" CssClass="clslabel">Early Check-Out:</asp:Label>
                            <asp:TextBox ID="txtCheckOut" Columns="10" MaxLength="10" runat="server"></asp:TextBox><a hidefocus onclick="if(self.gfPop)gfPop.fPopCalendar1(document.getElementById('txtCheckOut'),IniDate());return false;"
                            ...
                            <asp:Label ID="lblErrorPop" runat="server" EnableViewState="True" Style="display: none;" CssClass="validators">Invalid Date</asp:Label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td align="right" width="50%">
                        <asp:LinkButton ID="hplModifyRes" runat="server" EnableViewState="False" CssClass="dgLink">Save</asp:LinkButton>
                    </td>
                    <td align="right"></td>
                    <td width="50%">
