<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReservationBeds.aspx.vb" Inherits="RateManager.ReservationBeds" %>

<%@ Register TagPrefix="uc1" TagName="ctrlReservationsQuery" Src="../Modules/ctrlReservationsQueryBeds.ascx" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="Grid"  GridLines="None" runat="server" CssClass="DataGrid" ShowFooter="True" CellSpacing="0" AutoGenerateColumns="False"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="HotelGNombre" HeaderText="HotelGNombre"></asp:BoundColumn>											
											...
											<asp:BoundColumn DataField="NameRoomG" HeaderText="Tipo de habitaci&#243;n"></asp:BoundColumn>
											...
											<asp:BoundColumn DataField="NoConfGalileo" HeaderText="NoConfGalileo"></asp:BoundColumn>
