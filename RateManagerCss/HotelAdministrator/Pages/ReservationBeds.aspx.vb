Public Partial Class ReservationBeds
    Inherits PaginaBase
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CtrlReservationsQuery1.idHotel = 0 'MyBase.cInfoActual.Hotel
    ...
    Public Function ColumunsName(ByVal col As Columns) As String
        Select Case col
            ...
            Case Columns.NombreHotelGalileo
                Return PortalCulture.GetString("01616")
            Case Columns.NoConfGalileo
                Return PortalCulture.GetString("01617")
            Case Columns.Llegada
                Return PortalCulture.GetString("M000122")
            Case Columns.Salida
                Return PortalCulture.GetString("M000123")
            Case Columns.NombHab
                Return PortalCulture.GetString("M000066")
            Case Columns.Cantidad
                Return PortalCulture.GetString("00062")
            Case Columns.StatusNew
                Return PortalCulture.GetString("M000167")
            Case Columns.Fee
    ...
    Private Sub loadResources()
        ...
        Me.Grid.Columns(Columns.NombreHotelGalileo).HeaderText = ColumunsName(Columns.NombreHotelGalileo)
        ...
        Me.Grid.Columns(Columns.NombHab).HeaderText = ColumunsName(Columns.NombHab)
        ...
        Me.Grid.Columns(Columns.NoConfGalileo).HeaderText = ColumunsName(Columns.NoConfGalileo)
