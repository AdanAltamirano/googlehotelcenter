<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReservationPackages.aspx.vb" Inherits="RateManager.ReservationPackages" %>

<%@ Register TagPrefix="uc1" TagName="ctrlReservationsQuery" Src="../Modules/ctrlReservationsQueryPackages.ascx" %>
...
<head>
    ...
    <table style="display: none" id="tableExcel">
    </table>
    <form action='<%=Page.ResolveUrl("~")%>Pages/excel.aspx?rType=PkgRes' method="post"
    target="_blank" id="FormularioExportacion">
    <input type="hidden" id="datos_a_enviar" name="datos">
    </form>
		<form id="Form1" method="post" runat="server">
			...
			<table id="bookingcontainer" cellSpacing="0" cellPadding="2" width="650px" border="0">
				<tr>
					<td>
			...
			<asp:datagrid id="Grid"  GridLines="None" runat="server" CssClass="DataGrid" ShowFooter="True" CellSpacing="0" AutoGenerateColumns="False"
										...
										<Columns>
											<asp:TemplateColumn HeaderText="Itinerario">
												<ItemTemplate>
													<asp:LinkButton id="lnkItinerario" runat="server" CausesValidation="false" CommandName="DetalleReserva"
														CssClass="dgLink">
														<%#DataBinder.Eval(Container, "DataItem.Itinerary")%>
													</asp:LinkButton>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:BoundColumn Visible="False" DataField="packageid" HeaderText="ID"></asp:BoundColumn>
											...
											<asp:BoundColumn Visible="true" DataField="PorcPor" HeaderText="Fee"></asp:BoundColumn>
										</Columns>
