...
<%@ Control Language="vb" AutoEventWireup="false" Codebehind="ctrlReservationsQuery.ascx.vb" Inherits="RateManager.ctrlReservations" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
	...
	<TR>
		...
		<TD   align="left">
			<TABLE id="Table3" border="0" cellSpacing="0" cellPadding="0" width="300">
				<TR>
					<TD ></TD>
					<TD><asp:dropdownlist id="ddlCanal" runat="server" onchange="ShowHideOTASL(this.value);"></asp:dropdownlist></TD>
                    <TD align =right ><asp:label id="lblOTA" runat="server" style="display:none;">OTAS:</asp:label></TD>
		            <TD><asp:dropdownlist id="ddlOTAs" runat="server" style="display:none;"></asp:dropdownlist></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
	...
	<TR>
		<TD align="right"></TD>
		<TD align="left"></TD>
		<TD align="right"><asp:label id="lblAgencia" runat="server" visible="false">Transaccion</asp:label></TD>
		<TD align="left"><asp:dropdownlist id="ddlAgencias" runat="server" Visible="false"></asp:dropdownlist></TD>
	</TR>
	<TR>
		<TD align="right"></TD>
		<TD align="left"></TD>
...
<script>
    function ShowHideOTASL(valor) {
        var ddl = document.getElementById("<%=ddlOTAs.ClientID%>");
        var lbl = document.getElementById("<%=lblOTA.ClientID%>");
        if (valor == "IDS") {
    ...
    window.onload = function (e) {
        var ddl = document.getElementById("<%=ddlCanal.ClientID%>");
        ShowHideOTASL(ddl.value);
    }
</script>
