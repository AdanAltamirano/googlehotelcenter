...
Partial Public Class ctrlReservationsV2
    ...
    Public Function searchReservations(Optional ByVal newStatus As Integer = -1) As DataView
        ...
        Dim sAgencia As String = If(ddlAgencias.SelectedIndex > 0, ddlAgencias.SelectedValue, "")
        ...
        If UserChain Then
            ...
            Else
                Return getReservations(Me.idHotel, CheckIn, CheckOut, RoomId, Status, NameClient, Me.ddlFilterby.SelectedItem.Value, Agencia:=sAgencia)
            End If
        Else
            Return getReservations(Me.idHotel, CheckIn, CheckOut, RoomId, Status, NameClient, Me.ddlFilterby.SelectedItem.Value, Agencia:=sAgencia)
        End If
    ...
    ' Store procedures
    Public Const SPGETRESERVATIONS As String = "spReservations_GetByHotel2"
    ...
    Public Function getReservations(ByVal hotelId As Integer, ByVal CheckIn As DateTime, ByVal CheckOut As DateTime, ByVal RoomId As Integer, ByVal Status As Byte, ByVal NameClient As String, ByVal filter As String, Optional ByVal idUsuario As Integer = -1, Optional ByVal Agencia As String = "") As DataView
