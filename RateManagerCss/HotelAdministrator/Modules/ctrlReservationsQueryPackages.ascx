<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlReservationsQueryPackages.ascx.vb" Inherits="RateManager.ctrlReservationsQueryPackages" %>
...
<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
	...
	<TR>
		...
		<TD  align =right><asp:label id="lblAgency" runat="server" EnableViewState="False" CssClass="clsLabel">Agencia:</asp:label></TD>
		<TD><asp:dropdownlist id="ddlAgencies" runat="server" Width="170px" Visible="false" AutoPostBack="true" CausesValidation="false"></asp:dropdownlist></TD>
	</TR>
	<TR>
		...
		<TD align="right"><asp:label id="lblAgent" runat="server" EnableViewState="False" CssClass="clsLabel" Visible="false">Agente:</asp:label></TD>
		<TD align="left"><asp:dropdownlist id="ddlAgents" runat="server" Width="170px" Visible="false"></asp:dropdownlist></TD>
	</TR>
	<TR>
...
<tr><td style="text-align:right; padding-right:8px;"><asp:Hyperlink id="hlnkExcel" runat="server" Enabled="False" NavigateUrl="../pages/ExcelPackages.aspx"
