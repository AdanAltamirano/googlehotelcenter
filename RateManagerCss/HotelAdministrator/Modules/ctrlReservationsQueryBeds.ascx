<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrlReservationsQueryBeds.aspx.vb" Inherits="RateManager.ctrlReservationsQueryBeds" %>
...
<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
	...
	<TR>
		...
		<TD  align =right>
		    <asp:label id="lblTipoHab" runat="server" EnableViewState="False" CssClass="clsLabel">Tipo de habitación:</asp:label>
		    <asp:label id="lblNombreCliente" runat="server" EnableViewState="False" CssClass="clsLabel">Nombre del cliente:</asp:label>
		</TD>
		<TD>
		    <asp:textbox id="txtNameCustomer" runat="server" CssClass="textbox" MaxLength="80" Width="200px"></asp:textbox>
		    <asp:dropdownlist id="lstRoomType" runat="server" Width="240px" DESIGNTIMEDRAGDROP="26"></asp:dropdownlist><asp:customvalidator id="cvMissingRoomTypes" runat="server" CssClass="validators" ErrorMessage="No se encontraron tipos de habitación"
				Display="Dynamic" ControlToValidate="lstRoomType" ForeColor=" "></asp:customvalidator>
		</TD>
	</TR>
	<TR>
		...
		<TD align="right">
		    <asp:label id="lblAgency" runat="server" EnableViewState="False" CssClass="clsLabel">Agencia:</asp:label>
		</TD>
		<TD align="left">
		    <asp:dropdownlist id="ddlAgencies" runat="server" Width="170px" AutoPostBack="true" CausesValidation="false" Visible="false"></asp:dropdownlist>
		</TD>
	</TR>
	<TR>
		<TD align="right"></TD>
		<TD align="left"></TD>
		<TD align="right">
		    <asp:label id="lblAgent" runat="server" CssClass="clsLabel" Visible="false">Agente :</asp:label>
		</TD>
		<TD align="left">
		    <asp:dropdownlist id="ddlAgents" runat="server" Visible="false" Width="170px"></asp:dropdownlist>
		</TD>
	</TR>
	<TR>
		...
		<td align =right>
		    <asp:label id="lblCanal" runat="server" CssClass="clsLabel" Visible="true">Canal</asp:label>		    
		</td>
		<TD   align="left">
			<TABLE id="Table3" border="0" cellSpacing="0" cellPadding="0" width="300">
				<TR>
					<TD ></TD>
					<TD>
					    <asp:dropdownlist id="ddlCanal" runat="server" Visible="true"></asp:dropdownlist>					    
					</TD>
