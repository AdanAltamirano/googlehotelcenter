...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        lblPendingInfo.Text = PortalCulture.GetString("00582")
    ...
    Private Sub loaddata()
        If Not IsNothing(CompanyID) AndAlso IsNumeric(CompanyID) AndAlso CompanyID > -1 Then
            ...
            If ds.Hotels.Count > 0 Then
                ...
                Dim period As Oz.UniBilling.Common.MonthlyPeriod
                period = New Oz.UniBilling.Common.MonthlyPeriod(CByte(ddlperiodo.SelectedIndex + 1), Me.ddlyear.SelectedValue)
                BillingMng.GetBillingStatements(HotelIdentity, period, ds)
    ...
    Private Sub Page_PreRender1(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.PreRender
        lblTitle.Text = PortalCulture.GetString("00581")
        ...
        btnload.Text = PortalCulture.GetString("00583")
        ...
        Next
        ddlperiodo.SelectedIndex = Now.Month - 1
