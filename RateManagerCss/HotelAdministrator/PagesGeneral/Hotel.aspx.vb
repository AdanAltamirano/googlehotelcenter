...
#Region "Funciones generales"
        ...
        If Not dsHotel Is Nothing AndAlso dsHotel.Tables(dsHotel.HOTEL_TABLE).Rows.Count > 0 Then
            ...
            With New Hoteles
                ...
                If hr Then
                    ...
                    If Not publish Then Me.NotifyContentModification("Informaci�n del hotel", "Informaci�n General")
                End If
            End With
    ...
    Public Function validaTexto(ByVal bIdioma As Boolean, ByVal txtControlIdioma As CtrlIdioma, ByVal idDicc As Integer) As String
        ...
        If bIdioma = True Then 'valida Idioma Espa�ol
    ...
    Private Sub LoadResources()
        ...
        Rangevalidator2.Text = "" '"Edad min. de Ni�o es numerico (1-99)"
        RangeValidator7.Text = PortalCulture.GetString("01168")    '"Edad Max. de Ni�o es numerico (1-99)"
