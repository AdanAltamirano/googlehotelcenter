...
Partial Class HotelAsosiationActivitys
    Inherits PaginaBase
...
#End Region
        ...
        Try
            ...
            If Not FR Is Nothing AndAlso FR.Tables(0).Rows.Count > 0 Then
                ...
                For indice As Integer = 0 To chkFranquicias1.Items.Count - 1
                    If FR.Tables("Booking").Select("Empresa ='" + chkFranquicias1.Items(indice).Value.ToString() + "'").Length > 0 Then
                ...
                For indice As Integer = 0 To chkFranquicias2.Items.Count - 1
                    ...
                    If FR.Tables("Booking").Select("Empresa ='" + chkFranquicias2.Items(indice).Value.ToString() + "'").Length > 0 Then
                ...
                For indice As Integer = 0 To chkFranquicias3.Items.Count - 1
                    ...
                    If FR.Tables("Booking").Select("Empresa ='" + chkFranquicias3.Items(indice).Value.ToString() + "'").Length > 0 Then
                ...
                For indice As Integer = 0 To chkFranquicias4.Items.Count - 1
                    ...
                    If FR.Tables("Booking").Select("Empresa ='" + chkFranquicias4.Items(indice).Value.ToString() + "'").Length > 0 Then
    ...
    Private Sub AltaRelacion(ByVal Chaincode As String)
        Try
            ...
            Next
        Catch ex As Exception
            mensaje(" (AltaRelacion) " + ex.Message)
        End Try
    End Sub
    ...
    Private Sub Idiomas()
        ...
        Me.lbltitleCar.Text = PortalCulture.GetString("00880")
        ...
        Me.lblTitle.Text = PortalCulture.GetString("00879")
    End Sub
