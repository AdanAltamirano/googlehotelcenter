<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MapLocationInformationCCT.aspx.vb" ValidateRequest="false" Inherits="RateManager.MapLocationInformationCCT" %>
...
<%@ Register TagPrefix="uc1" TagName="MapLocationCCT" Src="../Portal/Modules/Contenido/MapLocationCCT.ascx" %>
						...
						<TABLE cellspacing=0 cellPadding="0" width="100%" border="0" id="Table2">
							<tr>
								<td><TABLE id="Table1" cellspacing=0 cellPadding="0" width="100%" border="0">										
										<tr>
											<td>
											    <uc1:MapLocationCCT ID="MapLocationCCT1" runat="server" />
											</td>
										</tr>
										<TR>
											<TD>
