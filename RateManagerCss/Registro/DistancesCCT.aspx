<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DistancesCCT.aspx.vb" ValidateRequest="false" Inherits="RateManager.DistancesCCT" %>
...
<%@ Register TagPrefix="uc1" TagName="CtrlDistanciasCCT" Src="../Portal/Modules/Contenido/CtrlDistanciasCCT.ascx" %>
						...
						<TABLE cellspacing=0 cellPadding="0" width="100%" border="0" id="Table2">
							<tr>
								<td><TABLE id="Table1" cellspacing=0 cellPadding="0" width="100%" border="0">										
										<tr>
											<td>
											    <uc1:CtrlDistanciasCCT ID="CtrlDistanciasCCT1" runat="server" />
											</td>
										</tr>
										<TR>
											<TD>
