...
Partial Class AttractionInformation
    Inherits Paginabase
    Protected WithEvents AreaAttraction1 As AreaAttraction
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            AreaAttraction1.pagina = "Registro/AttractionInformation.aspx"
            AreaAttraction1.nota = "Edición de las atracciones del hotel."
            Dim ds As DataTable
            With New PresentacionOpciones
                ds = .GetIdModulebyName("AreaAttraction")
                If Not ds Is Nothing AndAlso ds.Rows.Count = 1 Then
                    AreaAttraction1.IdModulo = ds.Rows(0)("IdModulo")
