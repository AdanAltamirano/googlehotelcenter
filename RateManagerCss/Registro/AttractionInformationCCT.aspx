<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AttractionInformationCCT.aspx.vb" ValidateRequest="false" Inherits="RateManager.AttractionInformationCCT" %>
...
<%@ Register TagPrefix="uc1" TagName="AreaAttraction" Src="../Portal/Modules/Contenido/AreaAttractionCCt.ascx" %>
						...
						<TABLE cellspacing=0 cellPadding="0" width="100%" border="0" id="Table2">
							<tr>
								<td><TABLE id="Table1" cellspacing=0 cellPadding="0" width="100%" border="0">										
										<tr>
											<td>
											    <uc1:AreaAttraction ID="AreaAttraction1" runat="server" />
											</td>
										</tr>
										<TR>
											<TD>
