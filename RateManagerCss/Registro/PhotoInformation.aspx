...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PhotoInformation.aspx.vb" Inherits="RateManager.PhotoInformation" ValidateRequest="False" %>
<%@ Register TagPrefix="uc1" TagName="ctrlFooter" Src="../Portal/Modules/ctrlFooter.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Photo" Src="../Portal/Modules/Contenido/Photo.ascx" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="5" rightMargin="0" MS_POSITIONING="FlowLayout">
		...
		<div class="clear">
            ...
            <div class="title">
                <asp:Label ID="lbltitle" runat="server" EnableViewState="False" Text="Fotos" CssClass="tituloSeccion"></asp:Label>
            </div>
         </div>
