...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="InformacionPropiedadCCT.aspx.vb" ValidateRequest="False" Inherits="RateManager.InformacionPropiedadCCT" %>
...
<%@ Register TagPrefix="uc1" TagName="InfoPropiedad" Src="../Portal/Modules/Contenido/InfoPropiedadCCT.ascx" %>
						...
						<TABLE cellspacing=0 cellPadding="0" width="100%" border="0" id="Table2">
							<tr>
								<td><TABLE id="Table1" cellspacing=0 cellPadding="0" width="100%" border="0">										
										<tr>
											<td><uc1:InfoPropiedad id="InfoPropiedad1" runat="server"></uc1:InfoPropiedad></td>
										</tr>
										<TR>
											<TD>
											</TD>
