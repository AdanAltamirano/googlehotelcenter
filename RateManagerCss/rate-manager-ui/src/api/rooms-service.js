...
const roomClosureGetAllRatePlans = Vue.resource(`${process.env.VUE_APP_API_URL}/closure/allrateplans/{hotelid}`);
...
export default {
     ...
     * @returns 
     */
    getAllRatePlansByHotelId(hotelid){
        return roomClosureGetAllRatePlans.get({
            hotelid:hotelid
        })
    },
    /**
