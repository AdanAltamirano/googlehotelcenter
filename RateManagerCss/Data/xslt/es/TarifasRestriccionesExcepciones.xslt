      ...
      <body>
        ...
        <xsl:for-each select="TarifasRestriccionesExcepciones/UpdateRateRestriction">
          <xsl:if test="position() = 1">
            <span>Tarifas Promoción de habitación, por ocupación</span>
          </xsl:if>
        </xsl:for-each >
        <xsl:for-each select="TarifasRestriccionesExcepciones/UpdatePlanFaresNR">
          <xsl:if test="position() = 1">
            <span>Tarifas Netas Promoción, por ocupación</span>
          </xsl:if>
        </xsl:for-each >
        ...
        <xsl:for-each select="TarifasRestriccionesExcepciones/_UpdateRateRestriction">
          <xsl:if test="position() = 1">
            <span>Tarifas Promoción de habitación por ocupación, Actualizado</span>
          </xsl:if>
        </xsl:for-each >
        <xsl:for-each select="TarifasRestriccionesExcepciones/_UpdatePlanFaresNR">
          <xsl:if test="position() = 1">
            <span>Tarifas Netas Promoción por ocupación, Actualizado</span>
          </xsl:if>
        </xsl:for-each >
