      ...
      <body>
        ...
        <xsl:for-each select="LockRatesPlanRooms/UpdateLockRates">
          <xsl:if test="position() = 1">
            <span>Disponibilidad por tipo habitación y plan</span>
          </xsl:if>
        </xsl:for-each >
        <xsl:for-each select="LockRatesPlanRooms/UpdateRoomSegment">
          <xsl:if test="position() = 1">
            <span>Disponibilidad por tipo habitación y plan por segmento</span>
          </xsl:if>
        </xsl:for-each >
        ...
        <xsl:for-each select="LockRatesPlanRooms/_UpdateLockRates">
          <xsl:if test="position() = 1">
            <span>Disponibilidad por tipo habitación y plan, Actualizado</span>
          </xsl:if>
        </xsl:for-each >
        <xsl:for-each select="LockRatesPlanRooms/_UpdateRoomSegment">
          <xsl:if test="position() = 1">
            <span>Disponibilidad por tipo habitación y plan por segmento, Actualizado</span>
          </xsl:if>
        </xsl:for-each >
        <table border="1" cellpadding="0" cellspacing="0"  >
          <xsl:for-each select="LockRatesPlanRooms/_UpdateLockRates">
