          ...
          <tr>
            <td valign="top">
              <table border="1" cellpadding="0" cellspacing="0">
                <xsl:for-each select="Empresas/UpdateRegisterCompany">
                  ...
                  <tr>
                    ...
                    <td  style="text-align:center;">
                      <xsl:value-of select="Contacto_Nombre"/>
                    </td>
                    <td  style="text-align:center;">
                      <xsl:value-of select="Contacto_Email"/>
                    </td>
                    <td>
                    ...
                    <td  style="text-align:center;">
                      <xsl:value-of select="ContactoGte_Nombre"/>
                    </td>
                    <td  style="text-align:center;">
                      <xsl:value-of select="ContactoGte_email"/>
                    </td>
                  </tr>
                </xsl:for-each>
                <TD colspan="6">&#160;</TD>
                <xsl:for-each select="Empresas/_UpdateRegisterCompany">
                  <tr>
                    <td  style="text-align:center;">
                      <xsl:value-of select="Nombre"/>
                    </td>
