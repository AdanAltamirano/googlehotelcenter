...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <br/>
        <span>General Information Hotel</span>
        ...
        <br/>
        <span>General Information Hotel, Update</span>
        <table border="1" cellpadding="0" cellspacing="0">
  ...
  <xsl:template name="Header">
    ...
    <tr bgcolor="#668800">
      <td>Users profile</td>
      <td>Status</td>
      <td>Email Reservations</td>
      <td>Min. Nights</td>
      <td>Max. Nights</td>
      <td>Min Rooms reserve</td>
      <td>Max Rooms reserve</td>
      <td>Currency Code</td>
